...
// FULL DISCLOSURE
// CryptocybeMiner is a fork from SushiSwap V1, just used in a diferent way.


// Cryptocybe with Governance.
contract Cryptocybe is ERC20("Cryptocybe", "CYB"), Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (CryptocybeMiner).
...
// File: contracts/CryptocybeMiner.sol
